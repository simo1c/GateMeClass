...
<p align="justify">
To select the parameter GMM_parameterization (V or E), it can be useful to explore the variance of the expeceted Gaussian components underlie the distribution of each marker: 
</p>
